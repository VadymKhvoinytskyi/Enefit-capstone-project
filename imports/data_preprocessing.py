...
def remove_col(merged_df, col_list=[], drop_row_id: bool = True):        
    ...
    if drop_row_id:
        drop_columns.append('row_id')

    if 'data_block_id' in model_df.columns:
        drop_columns.append('data_block_id')
